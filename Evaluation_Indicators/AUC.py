...
#     print '    Test_rd length：'+str(len(Test_rd))
#     print '    Test_rd max：'+str(max(Test_rd))
#     print '    NoExist_rd：'+str(NoExist_rd)
#     print '    NoExist_rd length：'+str(len(NoExist_rd))
...
#     print NoExist_Data.shape
    ...
    Test_rd = np.array([Test_Data[x] for index,x in enumerate(Test_rd)])    # Edge score value in the test set
    NoExist_rd = np.array([NoExist_Data[x] for index,x in enumerate(NoExist_rd)])   # Non-existent edge
#     print Test_rd
#     print Test_rd.shape
#     print NoExist_rd
